...
// ==============================================================
#ifndef __sobel_filter_mac_eOg__HH__
#define __sobel_filter_mac_eOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_filter_mac_eOg) {
    ...
    SC_CTOR(sobel_filter_mac_eOg):  simcore_mac_0_U ("simcore_mac_0_U") {
