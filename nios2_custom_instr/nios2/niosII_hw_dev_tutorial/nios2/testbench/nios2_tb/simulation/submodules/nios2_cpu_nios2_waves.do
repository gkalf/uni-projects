add wave -noupdate -divider {nios2_cpu: top-level ports}
...
add wave -noupdate -divider {nios2_cpu: base pipeline}
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/clk
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/reset_n
...
add wave -noupdate -divider {nios2_cpu: combinatorial_custom_instruction}
