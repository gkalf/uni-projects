...
HD_PWD='/home/gkmikros/Dropbox/CE435/Lab3/lab3_graycounter/lab3_graycounter.runs/lab3_simple_Gray_counter_ip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_simple_Gray_counter_ip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_simple_Gray_counter_ip_0_1.tcl
