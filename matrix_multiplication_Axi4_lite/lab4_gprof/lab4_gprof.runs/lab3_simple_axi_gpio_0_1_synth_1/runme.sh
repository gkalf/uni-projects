...
HD_PWD='/home/gkmikros/lab3.1_backup/lab3.1_backup.runs/lab3_simple_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_simple_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_simple_axi_gpio_0_1.tcl
