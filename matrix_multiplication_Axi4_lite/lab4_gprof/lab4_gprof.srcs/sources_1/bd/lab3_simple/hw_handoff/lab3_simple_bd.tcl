...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins sw_8bit/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M01_AXI [get_bd_intf_pins btns_5bit/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins Gray_counter_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net sw_8bit_GPIO [get_bd_intf_ports sws_8bits] [get_bd_intf_pins sw_8bit/GPIO]

  # Create port connections
  connect_bd_net -net Gray_counter_ip_0_LED [get_bd_ports LED] [get_bd_pins Gray_counter_ip_0/LED]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Gray_counter_ip_0/s00_axi_aclk] [get_bd_pins btns_5bit/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins sw_8bit/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Gray_counter_ip_0/s00_axi_aresetn] [get_bd_pins btns_5bit/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins sw_8bit/s_axi_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Gray_counter_ip_0/S00_AXI/S00_AXI_reg] SEG_Gray_counter_ip_0_S00_AXI_reg
...
preplace port sws_8bits -pg 1 -y 190 -defaultsOSRD
...
preplace inst btns_5bit -pg 1 -lvl 3 -y 70 -defaultsOSRD
preplace inst sw_8bit -pg 1 -lvl 3 -y 190 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 190 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -y 260 -defaultsOSRD
preplace inst Gray_counter_ip_0 -pg 1 -lvl 3 -y 330 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 420 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 3 NJ 380 770J 260 NJ
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 740
preplace netloc Gray_counter_ip_0_LED 1 3 1 N
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 430
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 450 350 760
preplace netloc sw_8bit_GPIO 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 170 410
preplace netloc btns_5bit_GPIO 1 3 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 400 NJ 400 NJ
preplace netloc ps7_0_axi_periph_1_M01_AXI 1 2 1 740
preplace netloc ps7_0_axi_periph_1_M00_AXI 1 2 1 N
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 150 420 20 750
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 440
levelinfo -pg 1 0 220 600 890 1020 -top 0 -bot 560
",
}
