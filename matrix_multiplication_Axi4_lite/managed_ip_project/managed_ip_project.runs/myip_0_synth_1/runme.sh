...
HD_PWD='/home/gkmikros/Dropbox/CE435/lab4/managed_ip_project/managed_ip_project.runs/myip_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myip_0.tcl
