...
HD_PWD='C:/Users/geoka/Documents/GitHub/uni-projects/lab4/lab4_matrix_multiplicatio/lab4_matrix_multiplicatio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_simple_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab3_simple_wrapper.tcl -notrace
