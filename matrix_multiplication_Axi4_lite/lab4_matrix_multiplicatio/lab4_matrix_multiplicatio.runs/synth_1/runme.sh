...
HD_PWD='C:/Users/geoka/Documents/GitHub/uni-projects/lab4/lab4_matrix_multiplicatio/lab4_matrix_multiplicatio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_simple_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_simple_wrapper.tcl
