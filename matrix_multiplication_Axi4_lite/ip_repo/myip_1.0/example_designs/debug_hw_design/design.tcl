...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins myip_0/S_AXI_INTR]
	connect_bd_net [get_bd_pins myip_0/s_axi_intr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins myip_0/s_axi_intr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins myip_0/S00_AXI]
	...
	connect_bd_net [get_bd_pins myip_0/irq] [get_bd_pins axi_gpio_irq/gpio_io_i]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_myip_0_S_AXI_INTR_* ]]
